...
import laporan.application.com.adapter.BencanaAdapter;
import laporan.application.com.adapter.KegiatanAdapter;
import elapor.application.com.elapor.R;
import laporan.application.com.fragment.BencanaFragment;
import laporan.application.com.fragment.KegiatanFragment;
...
public class MainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener {
	...
	final int REQUEST_FROM_BUAT_LAPORAN_KEGIATAN = 6;
	final int REQUEST_FROM_BUAT_LAPORAN_BENCANA = 5;
	...
	// LAPORAN KEGIATAN
	public static ArrayList<kegiatan> kegiatanlist = new ArrayList<>();
	public static KegiatanAdapter kegiatanAdapter;

	// LAPORAN BENCANA
	public static ArrayList<bencana> bencanalist = new ArrayList<>();
	...
	public void displayView(int position) {
		...
		switch (position) {
			...
			case 0: {
				...
				kegiatanlist = dh.kegiatanListData();
				kegiatanAdapter = new KegiatanAdapter(context, kegiatanlist);
			...
			case 1: {
				...
				bencanalist = dh.bencanaListData();
				bencanaAdapter = new BencanaAdapter(context, bencanalist);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		if (resultCode == RESULT_OK) {
			switch (requestCode) {
				...
				case REQUEST_FROM_BUAT_LAPORAN_KEGIATAN: {
					LoadDatakegiatan();
				...
				case REQUEST_FROM_BUAT_LAPORAN_BENCANA: {
					LoadDatabencana();
					String openfile = intent.getStringExtra("path");
					openFile(new File(openfile));
	...
	public void deleteKegiatan(kegiatan datast) {
	...
	public void deleteBencana(bencana datapl) {
		AlertDialog.Builder alert = new AlertDialog.Builder(context);
		alert.setTitle("Delete");
		alert.setMessage("Are you sure you want to delete?");
		alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
	...
	public void LoadDatakegiatan() {
		kegiatanlist = dh.kegiatanListData();
		kegiatanAdapter.UpdatKegiatanAdapter(kegiatanlist);
	}

	public void LoadDatabencana() {
		bencanalist = dh.bencanaListData();
		bencanaAdapter.UpdateBencanaAdapter(bencanalist);
	}
	...
	public void openkegiatan(kegiatan data) {
		Toast.makeText(context, "OPEN KEGIATAN", Toast.LENGTH_LONG).show();
	...
	public void buatLaporanKegiatan() {
		Intent intent = new Intent(context, BuatLaporanKegiatanActivity.class);
		startActivityForResult(intent, REQUEST_FROM_BUAT_LAPORAN_KEGIATAN);
	}

	public void buatLaporanBencana() {
		Intent intent = new Intent(context, BuatLaporanBencanaActivity.class);
		startActivityForResult(intent, REQUEST_FROM_BUAT_LAPORAN_BENCANA);
	}
