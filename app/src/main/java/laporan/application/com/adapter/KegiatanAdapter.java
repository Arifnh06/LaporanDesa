...
public class KegiatanAdapter extends BaseAdapter {
	...
	ArrayList<kegiatan> listdata = new ArrayList<>();
	Context context;

	public KegiatanAdapter(Context context, ArrayList<kegiatan> listdata) {
		this.context = context;
		this.listdata = listdata;
	}

	public void UpdatKegiatanAdapter(ArrayList<kegiatan> listdata) {
		this.listdata = listdata;
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		if(convertView==null) {
			view = new ViewHolder();
			convertView = inflator.inflate(R.layout.kegiatan_item_list, null);
		...
		final kegiatan info = listdata.get(position);
		...
		view.keterangan.setText("Jenis Kegiatan "+info.getJeniskegiatan()+"\nLokasi Kegiatan: "+info.getLokasikegiatan());
		...
		view.delete.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				((MainActivity) parent.getContext()).deleteKegiatan(info);
			}
		});
